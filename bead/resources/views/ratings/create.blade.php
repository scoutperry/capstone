...
@section('content')
    ...
    <form method='POST' action='/ratings'>
        ...
        <label for="donor_area">This project will not require building a whole new donor area (i.e.: archeology, contemporary
            etc.):</label>
        <input type="range" id="donor_area" name="donor_area" min="1" max="5">
        <br>

        <label for="foundation_timing">This project will either not require funding from Foundations or fits the timing for
        ...
        <label for="visitation_revenue">This project increases overall visitation (Incremental admissions revenue):</label>
        ...
        <label for="secondary_representation">This project includes secondary interpretation (i.e., sources consulted) from
        ...
        <label for="diverse_vendor">This project utilizes vendors from one or more of the groups described above:</label>
        ...
        <label for="code_law_regulation">This project satisfies a requirement outlined by code, law, or regulation:</label>
        <input type="range" id="code_law_regulation" name="code_law_regulation" min="1" max="5">
        <br>

        <label for="art_environment">This project will provide an opportunity to improve environmental systems where art is
            housed:</label>
        ...
        <label for="hvac_nonart">This project will provide an opportunity for repairs to the envelop, cooling and heating
        ...
        <label for="swing_space">This project will not require closure of galleries for swing space/storage of displaced
            material:</label>
        ...
        <label for="current_collection">The current collection can support the project or subsequent programming:</label>
